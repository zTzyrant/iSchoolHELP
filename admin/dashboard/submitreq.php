                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form action="" data-parsley-validate id="form2" style="display: none;">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input id="col-uname" type="text"  class="form-control" placeholder="Username" name="lname-column">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="col-pass" class="form-label">Password</label>
                                            <input type="password" id="col-pass" class="form-control" placeholder="Password" name="city-column">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="col-fullname" class="form-label">Fullname</label>
                                            <input type="text" id="col-fullname" class="form-control" name="country-floating" placeholder="Fullname">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="col-email" class="form-label">Email</label>
                                            <input type="text" id="col-email" class="form-control" name="country-floating" placeholder="Email@example.com">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="col-phone" class="form-label">Phone</label>
                                            <input type="number" id="col-phone" class="form-control" name="company-column" placeholder="Phone Number">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="col-pos" class="form-label">Position</label>
                                            <input type="text" id="col-pos" class="form-control" name="email-id-column" placeholder="Position">
                                        </div>
                                    </div>
                                    <div class="row">
                                    <div class="col-12 d-flex justify-content-end">
